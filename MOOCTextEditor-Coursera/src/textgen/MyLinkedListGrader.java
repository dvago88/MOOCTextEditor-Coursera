...
public class MyLinkedListGrader {
	...
	public void doTest()
	{
                ...
                String feedback = "";
		try {
			out = new PrintWriter("C:\\Users\\org\\Desktop\\_12cb4b1bb69bf9afee58424b3543c948_Course2StarterCode\\MOOCTextEditor-Coursera\\grader_output/module3.part1.out", "utf-8");
		} catch (Exception e) {
			e.printStackTrace();
			return;
		}
